...
public class Pays extends AbstractHistoEntity {
     ...
     *
     * @param code2 valeur à setter pour {@link #code2}
     */
     ...
     *
     * @param code3 valeur à setter pour {@link #code3}
     */
     ...
     *
	 * @param designation
	 *            valeur à setter pour {@link #designation}
     */
    ...
    public boolean isUpdateChangesAllowed(final IHistorisable bddData) {
		...
		// RG : la date de fin d'effet est modifiable tant qu'elle est vide ou
